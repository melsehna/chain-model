...
The core conclusion: the $1.81\times$ mutation-supply advantage from
Section~\ref{sec:lambda} is overwhelmed by the $83\times$ establishment
suppression. The upper-bound curves in Figure~\ref{fig:lambda} are
systematically misleading---extra mutations that cannot establish do not
