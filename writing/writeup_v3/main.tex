...
\input{sections/03_headline}

% Sections to come (placeholders, not yet drafted):
%   04: full dose curves + supply-and-establishment decomposition
%       (the framework that organizes everything below)
%   05: sensitivity (l and b_c sweeps; crossover-dose summaries)
